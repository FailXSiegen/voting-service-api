...
const config = {
  ...
  organizer.password = '*****'
  console.log('\x1b[32mA new organizer with the following data has been created successfully:\x1b[0m', organizer)
  process.exit(0)
})().catch((error) => {
  console.log('')
  console.log('\x1b[32mAn error occurred while trying to create a new organizer.\x1b[0m')
  console.error(error)
  process.exit(1)
})
